...
## Fast routing guide
- `trivial-local`: stay bounded, avoid heavy workflows, and use direct local artifacts first when the target is exact and the artifact already answers the question.
