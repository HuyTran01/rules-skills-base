...
description: Mirror Knowledge Graph memory writes into a human-readable memory/memory.md file inside the current project, so the user can audit project memory without opening the MCP JSON store.
---
